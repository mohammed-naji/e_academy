                ...
                <div class="row align-items-center">
                    <div class="col-lg-8">
                        <div class="header-contact text-lg-left text-center">
                            <ul>
                                <li><img src="{{ asset('images/all-icon/call.png') }}" alt="icon"><span>(124) 123 675 598</span></li>
                                <li><img src="{{ asset('images/all-icon/email.png') }}" alt="icon"><span>info@yourmail.com</span></li>
                                <li><img src="{{ asset('images/all-icon/map.png') }}" alt="icon"><span>127/5 Mark street, New york</span></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-4">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-about mt-40">
                            <div class="logo">
                                <a href="#"><img src="{{ asset('images/la.png') }}"
