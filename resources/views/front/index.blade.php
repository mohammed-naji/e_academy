...
<!--====== SLIDER PART START ======-->
    ...
    <section id="slider-part" class="slider-active">
        <div class="single-slider slider-2 bg_cover" style="background-image: url({{ asset('images/slider/s-1.jpg') }}" data-overlay="4">
            <div class="container">
                <div class="row">
        ...
        <div class="single-slider slider-2 bg_cover" style="background-image: url({{ asset('images/slider/s-3.jpg') }})" data-overlay="4">
            <div class="container">
                <div class="row">
                    <div class="col-xl-9 col-lg-10">
                        <div class="slider-cont">
                    ...
                    <div class="category-2-items pt-10">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="singel-items text-center mt-30">
                                    <div class="items-image">
                                        <img src="{{ asset('images/category/ctg-1.jpg') }}" alt="Category">
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="singel-items text-center mt-30">
                                    <div class="items-image">
                                        <img src="{{ asset('images/category/ctg-2.jpg') }}" alt="Category">
                                    </div>
                                    <div class="items-cont">
                                        <a href="courses.php">
                            ...
                            <div class="col-md-6">
                                <div class="singel-items text-center mt-30">
                                    <div class="items-image">
                                        <img src="{{ asset('images/category/ctg-3.jpg') }}" alt="Category">
                                    </div>
                                    <div class="items-cont">
                                        <a href="courses.php">
                                            <h5>UI/ UX Design</h5>
                            ...
                            <div class="col-md-6">
                                <div class="singel-items text-center mt-30">
                                    <div class="items-image">
                                        <img src="{{ asset('images/category/ctg-4.jpg') }}" alt="Category">
                                    </div>
                                    <div class="items-cont">
                                        <a href="courses.php">
                                            <h5>Photography</h5>
                            ...
                            <div class="col-md-6">
                                <div class="singel-items text-center mt-30">
                                    <div class="items-image">
                                        <img src="{{ asset('images/category/ctg-5.jpg') }}" alt="Category">
                                    </div>
                                    <div class="items-cont">
                                        <a href="courses.php">
                                            <h5>Finance</h5>
                            ...
                            <div class="col-md-6">
                                <div class="singel-items text-center mt-30">
                                    <div class="items-image">
                                        <img src="{{ asset('images/category/ctg-6.jpg') }}" alt="Category">
                                    </div>
                                    <div class="items-cont">
                                        <a href="courses.php">
                                            <h5>Science</h5>
    ...
    <div id="counter-part" class="bg_cover pt-65 pb-110" data-overlay="8" style="background-image: url({{ asset('images/bg-2.jpg') }})">
        <div class="container">
            <div class="row">
